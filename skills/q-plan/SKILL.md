---
description: "Review and prioritize next actions from relationships, objections, and pipeline data"
---
...
- Apply `audhd-executive-function` rule if enabled — friction-ordered, copy-paste ready
