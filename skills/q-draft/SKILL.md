---
description: "Ad-hoc output generation (quick email, DM, talking points)"
---
...
- Apply `founder-voice` rule — this is text another person will read
- Apply `audhd-executive-function` rule if enabled — output should be copy-paste ready
- No overclaiming
