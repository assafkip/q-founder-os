---
description: "Multi-pass content review pipeline (voice, guardrails, anti-AI)"
---
...
3. `{config_dir}/voice/voice-dna.md` — voice DNA
...
- Check content against founder-voice rule for higher-order patterns (scar pattern, contrast)
