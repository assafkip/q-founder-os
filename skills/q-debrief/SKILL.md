---
description: "Post-conversation structured extraction — routes insights to canonical files"
---
...
- Apply `founder-voice` rule to any drafted messages (follow-ups, design partner conversion)
