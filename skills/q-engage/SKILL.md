---
description: "Social engagement mode — generate copy-paste comments, DMs, and connection requests"
---
...
- Apply `founder-voice` rule to all comments and DMs
- Apply `audhd-executive-function` rule if enabled — comments should be copy-paste ready
