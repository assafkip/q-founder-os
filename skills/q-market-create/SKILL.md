---
description: "Generate marketing content aligned with brand voice and content themes"
---
...
- Apply `founder-voice` rule — mandatory for all marketing content
- Apply `audhd-executive-function` rule if enabled
- Run anti-AI detection patterns from founder-voice rule
