---
description: "Daily morning briefing — 8-phase agent pipeline producing a copy-paste-ready HTML schedule"
---
...
1. `q-system/agent-pipeline/preflight.md` — tool manifest, known issues, fallback chains. **MANDATORY before anything else.**
...
- Apply `audhd-executive-function` rule if enabled — this governs ALL output from Step 0e onward
