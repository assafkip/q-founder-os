...
python ${CLAUDE_SKILL_DIR}/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python ${CLAUDE_SKILL_DIR}/scripts/search-slides.py "series a funding" -d strategy --json
```
