# Output Formats, Tips, and Pre-Delivery Checklist
...
| Navigation feels confusing | Quick Reference S9: `nav-hierarchy` + `bottom-nav-limit` + `back-behavior` |
...
- Run through Quick Reference S1-S3 (CRITICAL + HIGH) as a final review
