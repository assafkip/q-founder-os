...
3. `q-system/canonical/engagement-playbook.md` — comment strategy, style rules, do/don't patterns
4. `q-system/canonical/market-intelligence.md` — context for evaluating posts
5. `q-system/my-project/relationships.md` — existing contacts for context
...
4. Route market signals to `canonical/market-intelligence.md`
