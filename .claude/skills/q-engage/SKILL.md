...
3. `~/.config/kipi/canonical/engagement-playbook.md` — comment strategy, style rules, do/don't patterns
4. `~/.config/kipi/canonical/market-intelligence.md` — context for evaluating posts
5. `~/.local/share/kipi/my-project/relationships.md` — existing contacts for context
...
4. Route market signals to `~/.config/kipi/canonical/market-intelligence.md`
