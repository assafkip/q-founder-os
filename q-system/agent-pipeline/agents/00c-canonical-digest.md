...
- `{config_dir}/canonical/talk-tracks.md` (615 lines)
- `{config_dir}/canonical/objections.md` (110 lines)
- `{data_dir}/my-project/current-state.md` (273 lines)
- `{config_dir}/canonical/discovery.md` (367 lines)
- `{config_dir}/canonical/decisions.md` (171 lines)

## Writes
- `{state_dir}/bus/{date}/canonical-digest.json`
...
### From talk-tracks.md:
- Primary metaphor - the exact phrasing
- Key definition - the exact phrasing
...
### Write to `{state_dir}/bus/{date}/canonical-digest.json`:
...
1. `talk_tracks.primary_metaphor` must be populated
2. `talk_tracks.key_definition` must be populated
