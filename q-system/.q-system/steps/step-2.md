...
| **Multi-team pain** | Describes cross-silo problem (exactly {{YOUR_PRODUCT}}'s value prop) | Describes single-team problem {{YOUR_PRODUCT}} solves | Single-tool problem (narrow, single-tool scope) |
