...
This template is the **primary workflow** of the Q Founder OS. Use it after every conversation with an investor, buyer, design partner, advisor, or potential recruit.
...
- **Switching intent:** Top priority. Move toward trial/DPA conversation. This is a real prospect.
...
### 7. Network expansion
- Who did they MENTION by name, role, or team?
...
## Design Partner Conversion (MANDATORY for practitioner/buyer conversations)

> This section closes the loop from conversation to action. Skip ONLY for pure investor conversations where design partnership isn't relevant.

After every conversation with a practitioner, buyer, or potential design partner, answer these questions:
...
- What output format do they need? Do we support it?
- What input types do they need? Which are built vs not built?
- What integration do they need? (their specific tools)
...
- **Test run:** "Send me 2-3 {{INPUTS}} you're already working with. I'll run them through and send back the output. You tell me if it's useful." (Zero integration, zero commitment, 10 min of their time)
- **Recorded demo of their scenario:** Take the exact scenario they described, run it through {{YOUR_PRODUCT}}, record a 2-min video showing their use case. Send on their preferred channel.
- **Output sample:** Generate a sample artifact in their format from a public source relevant to their domain. Send it with: "This is what {{YOUR_PRODUCT}} would produce for your team. Is this useful?"
...
- Make the ask tiny. Not "become a design partner." Just "send me {{INPUT}} and I'll show you what comes back."
- Specify what they get (output artifacts) and what it costs them (10 min)
...
- Log the specific misclassification
...
- Example triples:
  ...
  {"s":"Person Name","p":"objected_to","o":"objection","t":"YYYY-MM-DD"}
  {"s":"Person Name","p":"resonated_with","o":"phrase","t":"YYYY-MM-DD"}
  {"s":"Connector Name","p":"introduced","o":"Person Name","t":"YYYY-MM-DD"}
  ```
...
- [ ] Misclassification risk is assessed even if none detected
...
- [ ] **Design Partner Conversion completed** (for practitioner/buyer conversations only):
  ...
  - [ ] If investor-only conversation: marked "N/A - investor conversation"
